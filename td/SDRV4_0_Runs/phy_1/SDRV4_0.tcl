...
set rc [catch {
  open_project {SDRV4_0.prj}
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/SDRV4_0_gate.db}
  read_sdc ../../../pin/timing_cons.sdc
  place
  export_db {SDRV4_0_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file SDRV4_0_phy.area
  export_db {SDRV4_0_pr.db}
  start_timer
  report_timing -mode FINAL -net_info  -rpt_autogen true -file SDRV4_0_phy.timing
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid SDRV4_0_inst.bid
  bitgen -bit "SDRV4_0.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT

...
set rc [catch {
  ...
  elaborate -top {SDR_Pad}
  export_db {SDRV4_0_elaborate.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  read_adc ../../../pin/pin_anlogic.adc
  optimize_rtl
  report_area -file SDRV4_0_rtl.area
  export_db {SDRV4_0_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  ...
  optimize_gate -maparea SDRV4_0_gate.area
  legalize_phy_inst
  export_db {SDRV4_0_gate.db}
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT
